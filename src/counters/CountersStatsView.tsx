    ...
    <div className="flex flex-col items-center gap-4 p-6">
      ...
      {stats.length === 0 ? (
        ...
        <table className="w-full max-w-[640px] border-collapse">
          <thead>
            <tr>
              <th className={`${CELL} text-left font-medium text-neutral-500 dark:text-neutral-400`}>Counter</th>
              <th className={`${CELL} text-left font-medium text-neutral-500 dark:text-neutral-400`}>Used for</th>
